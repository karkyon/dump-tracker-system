...
// 🚨 修正: TypeScriptエラー解消（null チェック追加）
  ...
  const handleComplete = async () => {
    try {
      ...
      const inspectionResponse = await apiService.createInspectionRecord({
        vehicleId,      // ✅ nullチェック済み
        inspectorId: driverId,  // ✅ nullチェック済み
        inspectionType: 'POST_TRIP',
      ...
      const endResponse = await apiService.endOperation(operationId, {  // ✅ nullチェック済み
        endTime: new Date(),
