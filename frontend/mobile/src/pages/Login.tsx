...
import { User, Lock, Loader, CheckCircle2, AlertCircle } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8 animate-fade-in">
          <div className="inline-flex items-center justify-center w-24 h-24 bg-white/10 backdrop-blur-lg rounded-full mb-6 shadow-2xl">
            <User className="w-12 h-12 text-white" />
          </div>
          <h1 className="text-3xl font-bold text-white mb-2">運転日報アプリ</h1>
          <p className="text-blue-100 text-sm">ダンプトラック運行記録システム</p>
        </div>

        {/* ログインカード */}
        <div className="bg-white rounded-2xl shadow-2xl p-8 animate-slide-up">
          <div className="mb-8">
            <h2 className="text-2xl font-bold text-gray-800 text-center mb-2">ログイン</h2>
            <p className="text-gray-500 text-sm text-center">運転手アカウントでログインしてください</p>
          </div>
        ...
        <div className="text-center mt-6">
          ...
          <p className="text-white/50 text-xs mt-1">© 2025 Dump Tracker System</p>
        </div>
      </div>
    </div>
  );
