...
-- CreateEnum
CREATE TYPE "public"."activity_type" AS ENUM ('LOADING', 'UNLOADING', 'TRANSPORTING', 'WAITING', 'MAINTENANCE', 'REFUELING', 'BREAK', 'OTHER', 'POST_INSPECTION', 'TRIP_START', 'TRIP_END', 'PRE_INSPECTION');
...
-- CreateEnum
CREATE TYPE "public"."item_type" AS ENUM ('RECYCLED_MATERIAL', 'VIRGIN_MATERIAL', 'WASTE');

-- CreateEnum
CREATE TYPE "public"."location_type" AS ENUM ('DEPOT', 'DESTINATION', 'REST_AREA', 'FUEL_STATION', 'PICKUP', 'DELIVERY');
...
-- CreateIndex
CREATE INDEX "idx_audit_logs_operation" ON "public"."audit_logs"("operation_type" ASC);

-- CreateIndex
CREATE INDEX "idx_audit_logs_table" ON "public"."audit_logs"("table_name" ASC);

-- CreateIndex
CREATE INDEX "idx_audit_logs_time" ON "public"."audit_logs"("created_at" ASC);

-- CreateIndex
CREATE INDEX "idx_gps_logs_time" ON "public"."gps_logs"("recorded_at" ASC);

-- CreateIndex
CREATE INDEX "idx_gps_logs_vehicle" ON "public"."gps_logs"("vehicle_id" ASC);

-- CreateIndex
CREATE INDEX "idx_inspection_item_results_item" ON "public"."inspection_item_results"("inspection_item_id" ASC);

-- CreateIndex
CREATE INDEX "idx_inspection_item_results_passed" ON "public"."inspection_item_results"("is_passed" ASC);

-- CreateIndex
CREATE INDEX "idx_inspection_item_results_record" ON "public"."inspection_item_results"("inspection_record_id" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "inspection_item_results_unique" ON "public"."inspection_item_results"("inspection_record_id" ASC, "inspection_item_id" ASC);

-- CreateIndex
CREATE INDEX "idx_inspection_items_order" ON "public"."inspection_items"("inspection_type" ASC, "display_order" ASC);

-- CreateIndex
CREATE INDEX "idx_inspection_items_type" ON "public"."inspection_items"("inspection_type" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "inspection_items_name_type_unique" ON "public"."inspection_items"("name" ASC, "inspection_type" ASC);

-- CreateIndex
CREATE INDEX "idx_inspection_records_date" ON "public"."inspection_records"("created_at" ASC);

-- CreateIndex
CREATE INDEX "idx_inspection_records_inspector" ON "public"."inspection_records"("inspector_id" ASC);

-- CreateIndex
CREATE INDEX "idx_inspection_records_status" ON "public"."inspection_records"("status" ASC);

-- CreateIndex
CREATE INDEX "idx_inspection_records_type" ON "public"."inspection_records"("inspection_type" ASC);

-- CreateIndex
CREATE INDEX "idx_inspection_records_vehicle" ON "public"."inspection_records"("vehicle_id" ASC);

-- CreateIndex
CREATE INDEX "idx_items_display_order" ON "public"."items"("display_order" ASC);

-- CreateIndex
CREATE INDEX "idx_items_hazardous" ON "public"."items"("hazardous" ASC);

-- CreateIndex
CREATE INDEX "idx_items_is_fragile" ON "public"."items"("is_fragile" ASC);

-- CreateIndex
CREATE INDEX "idx_items_is_hazardous" ON "public"."items"("is_hazardous" ASC);

-- CreateIndex
CREATE INDEX "idx_items_requires_special_equipment" ON "public"."items"("requires_special_equipment" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "items_name_key" ON "public"."items"("name" ASC);

-- CreateIndex
CREATE INDEX "idx_locations_hazardous_area" ON "public"."locations"("hazardous_area" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "idx_locations_name" ON "public"."locations"("name" ASC);

-- CreateIndex
CREATE INDEX "idx_locations_type" ON "public"."locations"("location_type" ASC);

-- CreateIndex
CREATE INDEX "idx_maintenance_status" ON "public"."maintenance_records"("status" ASC);

-- CreateIndex
CREATE INDEX "idx_maintenance_type" ON "public"."maintenance_records"("maintenance_type" ASC);

-- CreateIndex
CREATE INDEX "idx_maintenance_vehicle" ON "public"."maintenance_records"("vehicle_id" ASC);

-- CreateIndex
CREATE INDEX "idx_notifications_priority" ON "public"."notifications"("priority" ASC);

-- CreateIndex
CREATE INDEX "idx_notifications_status" ON "public"."notifications"("status" ASC);

-- CreateIndex
CREATE INDEX "idx_notifications_status_priority" ON "public"."notifications"("status" ASC, "priority" ASC);

-- CreateIndex
CREATE INDEX "idx_notifications_type" ON "public"."notifications"("type" ASC);

-- CreateIndex
CREATE INDEX "idx_operation_details_activity" ON "public"."operation_details"("activity_type" ASC);

-- CreateIndex
CREATE INDEX "idx_operation_details_item" ON "public"."operation_details"("item_id" ASC);

-- CreateIndex
CREATE INDEX "idx_operation_details_location" ON "public"."operation_details"("location_id" ASC);

-- CreateIndex
CREATE INDEX "idx_operation_details_operation" ON "public"."operation_details"("operation_id" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "operation_details_operation_id_sequence_number_key" ON "public"."operation_details"("operation_id" ASC, "sequence_number" ASC);

-- CreateIndex
CREATE INDEX "idx_operations_driver" ON "public"."operations"("driver_id" ASC);

-- CreateIndex
CREATE INDEX "idx_operations_status" ON "public"."operations"("status" ASC);

-- CreateIndex
CREATE INDEX "idx_operations_vehicle" ON "public"."operations"("vehicle_id" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "operations_operation_number_key" ON "public"."operations"("operation_number" ASC);

-- CreateIndex
CREATE INDEX "idx_reports_created" ON "public"."reports"("created_at" ASC);

-- CreateIndex
CREATE INDEX "idx_reports_period" ON "public"."reports"("start_date" ASC, "end_date" ASC);

-- CreateIndex
CREATE INDEX "idx_reports_status" ON "public"."reports"("status" ASC);

-- CreateIndex
CREATE INDEX "idx_reports_type" ON "public"."reports"("report_type" ASC);

-- CreateIndex
CREATE INDEX "idx_reports_user" ON "public"."reports"("generated_by" ASC);
...
-- CreateIndex
CREATE INDEX "idx_vehicles_plate_number" ON "public"."vehicles"("plate_number" ASC);

-- CreateIndex
CREATE INDEX "idx_vehicles_status" ON "public"."vehicles"("status" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "vehicles_plate_number_key" ON "public"."vehicles"("plate_number" ASC);
