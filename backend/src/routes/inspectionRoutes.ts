 ...
 *           type: string
 *           format: uuid
 *         description: ✅ NEW - 運行IDでフィルタ(特定運行の点検記録取得)
 *       - in: query
 *         name: inspectorId
 *         schema:
 *           type: string
...
/**
 * ✅ routes/inspectionRoutes.ts - operationId対応完了版
 *
 * 【修正内容】
 * ✅ operationIdパラメータをSwagger定義に追加
